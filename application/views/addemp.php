...
<div class="container">
  ...
  <h2>Add Employee</h2>
  <form action="<?=base_url('home/addemp')?>" method="post" enctype="multipart/form-data" id="form1" name="form1">
    ...
    <div class="form-group">
      ...
      <input type="email" class="form-control" id="email" placeholder="Enter email" name="email" onchange="ValidateEmail(document.form1.email)" required> 
    </div>
